...
module.exports = __webpack_require__("k5/J");
...
/* harmony import */ var _api_secretKey__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("YcMO");
...
async function SignUp(req, res) {
  const db = await Object(_api_openDB__WEBPACK_IMPORTED_MODULE_2__[/* openDB */ "a"])(); // await db.migrate({force:true});
    ...
    bcrypt.hash(req.body.password, saltRounds, async function (err, hash) {
      ...
      if (!err && people) {
        const token = jwt.sign({
          sub: people.id,
          Email: people.email
        }, _api_secretKey__WEBPACK_IMPORTED_MODULE_1__[/* secretKey */ "a"], {
          expiresIn: '1h'
        });
        res.setHeader('Set-Cookie', cookie__WEBPACK_IMPORTED_MODULE_0___default.a.serialize('auth', token, {
          httpOnly: true,
          secure: true,
